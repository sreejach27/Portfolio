...
Experienced Software Developer with a strong background in using React, Angular, Next.js, Node.js, Express.js,
...
and React, improving performance by 60%, maintainability, and user experience through new design.
• Built a mobile-responsive platform using React and Node.js, integrating server-side rendering with Next.js 
to improve SEO and page load speed.
• Integrating GraphQL APIs for efficient data fetching, reducing API calls by 30%.
• Developing a full-stack website with AI-powered chatbot using React.js, Node.js, Express.js, and OpenAI 
...
JavaScript, developed interactive UI components using React.js, enhancing responsiveness and 
user engagement.
...
application using Next.js, React.js and express.js, enhancing the booking experience for 
patients.
• Used React-Query and Express.js for efficient API handling, reducing redundant API calls 
and improving app load times.
...
• Designed and implemented dynamic front-end interfaces with React, Angular, and Bootstrap, 
...
• Used Axios with React to integrate RESTful APIs, allowing real-time data retrieval and ensuring a 
seamless user experience.
• Collaborated with back-end developers to integrate Node.js and Express.js with the React front-end, ensuring smooth data flow and enhancing the application's functionality.
• Utilized Jest and React Testing Library to write unit and integration tests, ensuring high-quality, 
bug-free releases.
...
• Utilized React, Next.js to build dynamic, server-rendered, and statically generated components, 
improving performance, SEO, and user engagement.
...
Slack, GraphQL, Git, Github, Webpack, Bootstrap, Joomla, Figma, Cascade CMS, October.
PROJECTS:
...
designed the front-end using React and CSS for a responsive user experience and integrated the back-end with Node.js and MongoDB to ensure real-time updates. I also implemented Firebase 
...
college.
        ...
        link.href = url
        link.download = "Sreeja_Reddy_Resume.txt"
